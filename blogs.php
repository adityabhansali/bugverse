				...
				<div class="col-md-12 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							<h1>The Best Platform for Bug bounty hunters <em>in</em> World</h1>
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-4 fh5co-widget">
					<h4>Bugs</h4>
					<p>Find Bug secure system, world will be secured.</p>
				</div>
				...
				<div class="col-md-4 col-md-push-1 fh5co-widget">
					...
					<ul class="fh5co-footer-links">
						<li>B 206 <br> Amar deep Residency Bardoli 394601</li>
						<li><a href="tel://8128355018">+91 8128355018</a></li>
						<li><a href="#">adityabhansalijain@gmail.com</a></li>
						<li><a href="#">Stupidaschip</a></li>
					</ul>
				</div>
